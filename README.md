...
Затрачено времени на реализацию: 5 часов -- 1:30 - переработка главной страницы и создание страницы лидерборда, 3:30 - разработка логики для проверки попадания в лидерборд и обработки записи
